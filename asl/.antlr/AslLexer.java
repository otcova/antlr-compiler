...
public class AslLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"EQUAL", "NE", "LT", "GT", "LE", "GE", "AND", "OR", "NOT", "PLUS", "MINUS", 
			"MUL", "DIV", "MOD", "VAR", "INT", "FLOAT", "BOOL", "CHAR", "ARRAY", 
			"IF", "THEN", "ELSE", "ENDIF", "WHILE", "DO", "ENDWHILE", "FUNC", "ENDFUNC", 
			"RETURN", "READ", "WRITE", "BOOLVAL", "TRY", "ENDTRY", "CATCH", "THROW", 
